...
INSERT INTO oauth_client_details VALUES('integration_test_product_admin','oauth_server_api', '$2a$10$BurTWIy5NTF9GJJH4magz.9Bd4bBurWYG8tmXxeQh1vs7r/wnCFG2', 'read,write', 'password', 'http://127.0.0.1', 'ROLE_PRODUCT_ADMIN', 1800, 0, NULL, 'true');
...
INSERT INTO oauth_client_details VALUES('integration_test_resource_admin','oauth_server_api', '$2a$10$BurTWIy5NTF9GJJH4magz.9Bd4bBurWYG8tmXxeQh1vs7r/wnCFG2', 'read,write', 'password', 'http://127.0.0.1', 'ROLE_RESOURCE_ADMIN', 30, 0, NULL, 'true');
