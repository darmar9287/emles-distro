...
CREATE SCHEMA IF NOT EXISTS "emles-distribution";
...
CREATE TABLE IF NOT EXISTS "emles-distribution".customer (
...
CREATE TABLE IF NOT EXISTS "emles-distribution"."order" (
...
CREATE TABLE IF NOT EXISTS "emles-distribution".order_detail (
...
CREATE TABLE IF NOT EXISTS "emles-distribution".product (
    product_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS "emles-distribution"."user" (
    user_id integer NOT NULL,
